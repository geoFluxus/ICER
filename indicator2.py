...
rladder_full = pd.read_excel('Private_data/R-ladder.xlsx', sheet_name='R-ladder')
...
# SPLIT AND SAVE DATA PER PROVINCE
ewc_names = pd.read_excel('Private_data/EWC_NAMES.xlsx')
process_names = pd.read_excel('Private_data/PROCESS_NAMES.xlsx')
...
for province in provinces:
    ...
    prov_data.to_excel(f'Private_data/results_per_province/{province}/Ind.2_{province}_afvalstatistiek.xlsx')
...
#
#         with pd.ExcelWriter(f'Private_data/results_per_province/{province}/Ind.2_{province}.xlsx') as writer:
